...
class Configuration(wx.Frame):
    ...
    def create_header_label(self) -> wx.BoxSizer:
        ...
        #     wx.EVT_BUTTON, lambda event: self.verify_pacs(event, self.pacs_table))
        ...
        #     event, self.pacs_table, self.delete_pacs_button))
        ...
        #     event, self.pacs_table, self.up_button))
        ...
        #     event, self.pacs_table, self.down_button))
